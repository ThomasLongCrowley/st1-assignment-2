...
def book_appointment(patient_name, practitioner_name, appointment_time):
    ...
    # Added one controlled improvement
...
# blank patient name to test error handling
book_appointment('', 'Dr. John Doe', '2024-07-20 10:00 AM')
# blank practitioner name to test error handling
book_appointment('Bob Johnson', '', '2024-07-20 11:30 AM')
# tested double booking
book_appointment('Alice Smith', 'Dr. John Doe', '2024-07-20 10:00 AM')
